...
namespace PMACS_V2
{
    public class MvcApplication : System.Web.HttpApplication
    {
        ...
        private void RegisterDependencyInjection()
        {
            ...
            container.RegisterType<IMoldTooling, IMoldToolRespository>(new ContainerControlledLifetimeManager());
            container.RegisterType<IDieMasterList, MoldDieMasterlistRepository>(new ContainerControlledLifetimeManager());
