...
namespace POS_System
{
    public partial class Flashscreen : Form
    {
        ...
        //        string defaultPassword = SecurityPassword.HashPassword("admin123");

        //        //await DBSqlHelper.ExecuteNonQueryAsync(createTableQuery);

        //        // ================= CHECK IF ADMIN EXISTS =================
        //        UpdateProgress(70, "Checking default admin...");
        ...
        //        VALUES
        //        (@FullName, @Username, @PasswordHash, @Role, 1);";
        ...
        //    catch (Exception ex)
        //    {
        //        MessageBox.Show("SQLite Setup Error: " + ex.Message);
        //    }
        //}
        // ==========================================================
        // 🔥 BULK IMPORT METHOD
